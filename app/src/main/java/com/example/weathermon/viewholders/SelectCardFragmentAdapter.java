...
public class SelectCardFragmentAdapter extends ListAdapter<CardWithMonster, CardMaintenanceViewHolder> {
    private CardSelectListener cardSelectListener;

    public SelectCardFragmentAdapter(@NonNull DiffUtil.ItemCallback<CardWithMonster> diffCallBack, CardSelectListener listener){
        super(diffCallBack);
